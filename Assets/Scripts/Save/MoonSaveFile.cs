...
namespace Save
{
    ...
    public class MoonSaveFile
    {
        ...
        private static string FilePath => Path.Combine(Application.persistentDataPath, "moonSave.json");
        public static MoonSaveFile Current { get; private set; }
        ...
        private static void Load()
        {
            ...
            else if (Current == null)
            {
                ...
                {
                    Current = JsonConvert.DeserializeObject<MoonSaveFile>(File.ReadAllText(FilePath));
                }
                else
                {
                    Current = new MoonSaveFile();
